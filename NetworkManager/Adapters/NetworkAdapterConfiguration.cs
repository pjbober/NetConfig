...
{
    public static class AdapterConfigurationEnumerator
    {

        public static IList<NetworkAdapterConfiguration> GetAllAdapterConfigurations()
        {
            IList<NetworkAdapterConfiguration> configurations = new List<NetworkAdapterConfiguration>();

            SelectQuery query = new SelectQuery("Win32_NetworkAdapterConfiguration");
            ManagementObjectSearcher search = new ManagementObjectSearcher(query);

            foreach (ManagementObject result in search.Get())
                configurations.Add(new NetworkAdapterConfiguration(result));
    ...
    // Klasa Elary Bound wygenerowana dla klasy usługi WMI.Win32_NetworkAdapterConfiguration
